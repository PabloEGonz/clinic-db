...
CREATE INDEX med_hist_treat_md_his_id_idx ON medical_history_treatments(medical_history_id);

CREATE INDEX med_hist_treat_tear_id_idx ON medical_history_treatments(treatments_id);
